#!/usr/bin/env node
/* example: node setAbsoluteMarker3.js --password=<..> --x=-0.1295 --y=0.082 --z=0.0 --color white --name device2 --spinning true */
...
var spec = {
    ...
    from: argv.from || 'demo-newdevice1',
    ca: argv.from || 'demo-newdevice1',
...
var URL = 'https://root-bodysnatcherlite.' + SUFFIX;
